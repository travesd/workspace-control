...
scope: service
verified: 2026-05-25
source: "/workspace/detection-platform-metal-work/knowledge/feedback_audit_mirror_production_definition.md"
...
# Audit must mirror production definition
...
Canonical home:
`/workspace/detection-platform-metal-work/knowledge/feedback_audit_mirror_production_definition.md`

Migration record:
`/workspace/detection-platform-metal-work/knowledge/MIGRATION-20260525.md`

Reason: Product/service audit guidance preserved here until a deliberate product-doc destination is selected.
