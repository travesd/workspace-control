...
- Concrete conditions where this note is relevant.
...
- Evidence summary with source path or URL.
- Re-check condition if it is not already obvious from frontmatter.
